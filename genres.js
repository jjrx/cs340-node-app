module.exports = function(){
    ...
    function getBooksByGenre(res, mysql, context, id, complete){
      var query = "SELECT bookCover, Books.bookID, bookTitle FROM Genres INNER JOIN BookGenres ON Genres.genreID = BookGenres.genreID INNER JOIN Books ON BookGenres.bookID = Books.bookID WHERE Genres.genreID = ?";
      var inserts = [id];
